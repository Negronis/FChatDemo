...
router.get('/getMessage', (req, res) => {
   let sendData = [
      ...
      { "content": "好？", "type": "message", "pos": "right" },
      { "content": "！", "type": "message", "pos": "left" },
      { "content": "没了？", "type": "message", "pos": "right" }
      , { "content": "没了！", "type": "message", "pos": "left" },
      { "content": "来根华子？", "type": "message", "pos": "right" },
      { "content": "那玩意咳shou！", "type": "message", "pos": "left" },
      { "content": "嗷", "type": "message", "pos": "right" },
      { "content": "http://192.168.1.4:8080/img.png", "type": "image", "pos": "right" },
      { "content": "的", "type": "message", "pos": "left" },
      { "content": "素质", "type": "message", "pos": "right" },
      { "content": "下子？", "type": "message", "pos": "left" },
   ];
   res.json(sendData);
})
router.post('/sendMessage', jsonParser, (req, res) => {
   ...
   if(type == 'audio'){
      // buffer转化为base64编码 
      sendData = req.body;
      sendData['content'] = 'http://192.168.1.4:8080/mp3/';
      res.json(sendData);
   }
});
// 微信接口
